...
# df_ImpVitalsP = pd.DataFrame()
# current_node = impVitals.head

# # Iterate through the linked list, collecting the DataFrames
# # while current_node is not None:
# node_df = pd.DataFrame([current_node.display])  # List to collect DataFrames
# df_ImpVitalsP = pd.concat([df_ImpVitalsP, node_df], ignore_index=True)
#     # current_node = current_node.next

# mno.matrix(df_ImpVitalsP, figsize=(20, 6))  # This line displays NaNs in df_ImpVitalsP